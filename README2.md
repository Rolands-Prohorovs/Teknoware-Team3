...
| ------------------------------- | ----------- | --------------------- |
| Class work | 36 | Lab session |
| Research ESP32 capabilities and GPIO connections | 3 | Understand microcontroller functionality |
| Sensor selection | 2 | Choose sensors, which will be integrated |
| Creating Wokwi prototype | 4 | Time spent designing the project in Wokwi |
